...
def cuadrado(ladoe):
    if ladoe <= 0 or ladoe <= 0:
        print("Solo puedes usar numeros positivos")

    calculo_del_cuadrado = ladoe ** 2
    return f"El area del cuadrado es: {calculo_del_cuadrado:.2f}"
...
opcion = int(input("Elige una entre 1-5: "))
